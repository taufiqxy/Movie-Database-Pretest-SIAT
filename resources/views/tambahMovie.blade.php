        ...
        <div class="col-md-8 col-xl-6">
            ...
            <form action="/tambah-movie" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="judul" name="judul" value="{{ old('nim') }}"
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="genre" id="genre"
                        value="{{ old('genre') }}">
                        <option value="Aksi"
                        {{ old('genre')=='Aksi' ? 'selected': '' }} >
                        Aksi
                        </option>
                        <option value="Komedi"
                        {{ old('genre')=='Komedi' ? 'selected': '' }} >
                        Komedi
                        </option>
                        <option value="Drama"
                        {{ old('genre')=='Drama' ? 'selected': '' }} >
                        Drama
                        </option>
                        <option value="Fiksi Ilmiah"
                        {{ old('genre')=='Fiksi Ilmiah' ? 'selected': '' }} >
                        Fiksi Ilmiah
                        </option>
                        <option value="Horor"
                        {{ old('genre')=='Horor' ? 'selected': '' }} >
                        Horor
                        </option>
                        <option value="Dokumenter"
                        {{ old('genre')=='Dokumenter' ? 'selected': '' }} >
                        Dokumenter
                        </option>
                    </select>
                    @error('genre')
